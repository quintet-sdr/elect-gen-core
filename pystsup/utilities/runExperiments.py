...
def runExperiments(configFile, experimentsFolder, outputName):
    ...
    headings = ['numberOfStudents', 'numberOfcourses', 'quotaSum', 'testCase', 'popSize', 'mutProb', 'swapProb',
    ...
    for filename in files:
        ...
        identifier = str(expDetails['numberOfStudents']) + "\t" + str(expDetails['numberOfcourses']) + "\t" + str(
                ...
                for swapProb in swapProbabilities:
                    ...
                    for crossoverOp in crossoverOperators:
                        ...
                        if crossoverOp == 'crossover' or crossoverOp == 'uniform' or crossoverOp == 'sp_crossover' or crossoverOp == 'none':
                            ...
                            geneticAlgorithm = GeneticAlgorithm(students, courses, fitnessCache, rankWeights, muOp,
