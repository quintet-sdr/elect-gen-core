...
#
#     for student in students:
#         available_courses = [course_name_to_object[course_name] for course_name in student.availableCourses if course_quotas[course_name_to_object[course_name].ID] > 0]
...
#
#     # Create a dictionary to map course names to Course objects
#     course_name_to_object = {course.name: course for course in courses_copy}
#
