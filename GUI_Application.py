...
class Window(Frame):
    ...
    def init_window(self):
        ...
        self.master.title("Course Allocation")
        ...
        self.label_2 = Label(self.master, relief=RIDGE, width=63, text="Select courses File")
    ...
    def startRUN(self, students, courses):
        ...
        geneticAlgorithm = GeneticAlgorithm(students, courses, fitnessCache, rankWeights, muOp, crOp, selOp)
    ...
    def runGA(self):
        ...
        if self.stuFile != None or self.supFile != None or self.outputName != None or self.keywordsFile != None:
            ...
            students, courses = getData(self.stuFile, self.supFile, keywordsFile=self.keywordsFile)

            non_dominated_solutions, metricData = self.startRUN(students, courses)

            print("Saving the results..")
            writeFrontier(self.outputName, non_dominated_solutions, metricData, courses, students)
            ...
            showerror("Error", "Input files not provided. Please select appropriate student and course data files.")
    ...
    def selectFile2(self):
        ...
        filename = askopenfilename(title="Select course Data File", filetypes=[("Excel Files", "*.xlsx")])
        self.supFile = filename
        toshow = "course File = " + filename.split("/")[-1]
    ...
    def editGAConfig(self):
        ...
        label1 = Label(self.top1, text="NOT WORKING! Generation Convergence Limit")
        label2 = Label(self.top1, text="Population Size")
        label3 = Label(self.top1, text="EXP Mutation Probability")
        label4 = Label(self.top1, text="EXP Swap Probability")
        label5 = Label(self.top1, text="EXP Transfer Probability")
